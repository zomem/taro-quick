...
const {screenHeight, windowWidth} = Taro.getSystemInfoSync()
...
const Drawer: FC<Drawer> = (props: Drawer) => {
  ...
  return (
    <Block>
      <Animate onClick={onCancel} bgColor={backBgColor} size={size} animation={animate.back} position='fixed' top='0' left='0' zIndex='400'>
        <Animate
