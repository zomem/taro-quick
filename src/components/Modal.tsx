import {ReactNode, useState, useEffect, useMemo, FC} from 'react'
...
const Modal: FC<Modal> = (props: Modal) => {
  ...
  }, [isShow, windowWidth, screenHeight])
  ...
  return(
    ...
    >
      <View 
        ...
        style={{backgroundColor: bgColor, ...msize}}
        onClick={(e) => {
          e.stopPropagation()
        }}
      >
